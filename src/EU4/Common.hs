...
ppHandlers = Tr.fromList
        ...
        ,("num_of_total_ports"               , numeric MsgNumPorts) -- duplicate?
        ...
        ,("colonists"                         , numericIcon "colonist" MsgGainColonists)
        ,("blockade_efficiency"               , numericIcon "blockade efficiency" MsgGainBlockadeEfficiency)
        ,("build_cost"                        , numericIcon "build cost" MsgGainBuildCost)
        ,("church_power_modifier"             , numericIcon "church power" MsgGainChurchPowerModifier)
        ,("culture_conversion_cost"           , numericIcon "culture conversion cost" MsgGainCultureConvCost)
        ,("development_cost"                  , numericIcon "development cost" MsgGainDevelCost)
        ,("devotion"                          , numericIcon "devotion" MsgGainYearlyDevotion)
        ,("global_autonomy"                   , numericIcon "global autonomy" MsgGainGlobalAutonomy)
        ,("global_colonial_growth"            , numericIcon "global settler increase" MsgGainGlobalSettlers)
        ,("global_missionary_strength"        , numericIcon "missionary strength" MsgGainMissionaryStrength)
        ,("global_ship_repair"                , numericIcon "global ship repair" MsgGainGlobalShipRepair)
        ,("global_ship_cost"                  , numericIcon "ship cost" MsgGainGlobalShipCost)
        ,("global_tax_modifier"               , numericIcon "global tax modifier" MsgGainGlobalTaxModifier)
        ,("global_tariffs"                    , numericIcon "global tariffs" MsgGainGlobalTariffs)
        ,("inflation_reduction"               , numericIcon "inflation reduction" MsgGainYearlyInflationReduction)
        ,("interest"                          , numericIcon "interest" MsgGainInterestPerAnnum)
        ,("land_maintenance_modifier"         , numericIcon "land maintenance" MsgGainLandMaintenanceMod)
        ,("leader_naval_manuever" {- sic -}   , numericIcon "naval forcelimit" MsgGainNavalLeaderManeuver)
        ,("light_ship_power"                  , numericIcon "light ship combat ability" MsgGainLightShipPower)
        ,("missionaries"                      , numericIcon "colonist" MsgGainMissionaries)
        ,("global_heretic_missionary_strength", numericIcon "missionary strength vs heretics" MsgGainMissionaryStrengthVsHeretics)
        ,("monthly_fervor_increase"           , numericIcon "monthly fervor" MsgGainMonthlyFervor)
        ,("naval_forcelimit_modifier"         , numericIcon "naval forcelimit" MsgGainNavalForcelimitMod)
        ,("navy_tradition"                    , numericIcon "navy tradition" MsgGainYearlyNavyTradition)
        ,("papal_influence"                   , numericIcon "papal influence" MsgGainYearlyPapalInfluence)
        ,("prestige"                          , numericIcon "prestige" MsgGainYearlyPrestige)
        ,("production_efficiency"             , numericIcon "production efficiency" MsgGainProdEff)
        ,("stability_cost_modifier"           , numericIcon "stability cost" MsgGainStabilityCost)
        ,("tolerance_own"                     , numericIcon "tolerance of the true faith" MsgGainToleranceTrue)
        -- Modifiers
